...
const validate = (values) => {
	...
	errors.from = tm(values.from).isAfter(values.to, 'YYYY-MM-DD HH:mm')
		? 'Value can\'t be later then to value'
		: undefined;

	errors.to =	tm(values.to).isBefore(values.from, 'YYYY-MM-DD HH:mm')
	...
	render() {
		...
		return (
			<div className={classes.controls}>
						...
						<div className={classes.customBlockControls}>
							...
							{_.includes(settings, 'date') && (
								<React.Fragment>
									<div className={`
											${classes.formStyle} 
											${addClassDataPickerDispanser ? 'wrapPageDispenser' : ''}
											${addClassForWithdraw ? 'wrapPageWithdraw' : ''}
											${addClassForDeposit ? 'wrapPageDeposit' : ''}
											${addClassPageReports ? 'wrapPageReports' : ''}
									`}>
				...
				<div className={`
					${classes.rightBlock} 
					${addClassForWithdraw ? 'wrapPageWithdrawRightSearch' : ''}
					${addClassForDeposit ? 'wrapPageDepositRightSearch' : ''}`
				}>
