...
const FieldTextValidatorAmount = (props) => {
const	{
	classes,
	name,
	input,
	...
	return (
		<FormControl
			error={Boolean(helperText) && Boolean(!active) || Boolean(error)}
		...
		>
			<TextField
				...
				{...custom}
			/>
			<FormHelperText htmlFor={name}>{!active && helperText || error}</FormHelperText>
		</FormControl>
	)
};
FieldTextValidatorAmount.defaultProps = {
	name: 'name',
	type: 'text',
	carefully: false
};

FieldTextValidatorAmount.propTypes = {
...
export default withStyles(styles)(FieldTextValidatorAmount);
